    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-10">
            ...
            <div class="flex items-center gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Thêm Ca Làm Việc Mới</h1>
                    <p class="text-gray-500 mt-1">Thiết lập ca làm việc cho nhân viên</p>
                </div>
            </div>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-3xl shadow-lg border border-gray-100 p-8 md:p-10">
            ...
            <form action="{{ route('admin.shifts.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                           placeholder="Ví dụ: Ca Sáng, Ca Chiều Chính, Ca Tối..."
                           class="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-200 transition">
                    @error('name')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="late_allow_minutes" name="late_allow_minutes"
                                   value="{{ old('late_allow_minutes', 10) }}" min="0"
                                   class="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="early_leave_allow_minutes" name="early_leave_allow_minutes"
                                   value="{{ old('early_leave_allow_minutes', 10) }}" min="0"
                                   class="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:border-blue-500">
                            <span class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 text-sm">phút</span>
                        </div>
                    </div>
                ...
                <!-- Mô tả -->
                <div class="mb-8">
                    <label for="description" class="block text-sm font-semibold text-gray-700 mb-2">Mô Tả Ca Làm</label>
                    <textarea id="description" name="description" rows="4"
                              class="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:border-blue-500 resize-none"
                              placeholder="Mô tả chi tiết về ca làm việc...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="flex gap-4">
                    <button type="submit"
                            class="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-semibold transition flex items-center justify-center gap-2 shadow-sm">
